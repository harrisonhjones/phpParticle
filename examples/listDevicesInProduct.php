...
/*
 * @project phpParticle
 * @file    examples/listDevicesInProduct.php
...
// By setting the product slug all applicable operations become product-specific.
$particle->setProductSlug($productSlug);

// List all the devices on your account
$particle->debug("Particle Devices");
